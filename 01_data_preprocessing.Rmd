...
save(raw_data_full, file = "data/raw_data_full.RData")
write.csv(raw_data_full, file = "data/raw_data_full.csv") 

save(raw_data_recoded, file = "data/raw_data_recoded.RData")
write.csv(raw_data_recoded, file = "data/raw_data_recoded.csv") 
```
